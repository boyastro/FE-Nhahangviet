        ...
        <div className='w-[400px] bg-white p-8 rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.3)]'>
          ...
          {form === 'login' && (
            <form onSubmit={handleLogin} className='flex flex-col gap-6'>
              ...
              <input value={username} onChange={e => setUsername(e.target.value)} type="text" placeholder="Tên đăng nhập" required className='h-[50px] border rounded-full px-4 outline-none' />
              <input value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="Mật khẩu" required className='h-[50px] border rounded-full px-4 outline-none' />
          ...
          {form === 'signup' && (
            <form onSubmit={handleSignup} className='flex flex-col gap-6'>
              ...
              <input value={username} onChange={e => setUsername(e.target.value)} type="text" placeholder="Tên đăng nhập" required className='h-[50px] border rounded-full px-4 outline-none' />
              <input value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder="Email" required className='h-[50px] border rounded-full px-4 outline-none' />
              <input value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="Mật khẩu" required className='h-[50px] border rounded-full px-4 outline-none' />
