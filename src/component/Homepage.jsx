        ...
        <>
            ...
            <section className='relative'>
                ...
                <header className='absolute top-[200px] left-[690px] text-center'>
                    ...
                    {/* --------- Header --------- */}
                    <h1 className='font-PlayfairD text-[100px] font-normal leading-[96px]'>Tinh Hoa <br /> Ẩm Thực Việt</h1>
                    <p className='mt-8 font-DM_sans text-xl font-normal'>Khám khá ẩm thực ba miền <br /> các món ngon đồng quê.</p>

                    {/* --------- Booking part --------- */}
                    <button className='mt-10 flex gap-4 ml-[100px] text-[#182226] text-base font-DM_sans font-bold'>
                        <Link to = "/book"><button className='px-8 py-5 border-2 border-[#2C2F24] rounded-full hover:bg-[#AD343E] hover:text-white hover:border-[#AD343E] transition duration-200'>Đặt bàn</button></Link>
                        <Link to = "/manu"><button className='px-8 py-5 border-2 border-[#2C2F24] rounded-full hover:bg-[#AD343E] hover:text-white hover:border-[#AD343E] transition duration-200'>Khám phá thực đơn</button></Link> 
                    </button>
                </header>
            </section>
            ...
            <section className='container pt-[92px] pb-[120px]'>
                <h2 className='font-PlayfairD font-medium text-[55px] leading-[60px] text-[#2C2F24] text-center'>Danh Sách Thực Đơn</h2>
                ...
                <div className='container flex justify-between'>
                    ...
                    <ul>
                        ...
                        <ul className='p-[50px] bg-[#474747] rounded-xl flex flex-col items-start w-[410px] text-white gap-[25px] translate-x-[240px] translate-y-[-250px]'>
                            ...
                            <a href='#' className='font-DM_sans text-base font-normal flex items-center hover:text-red-200'>< FaPhone className='text-xl mr-5' />(084)0244556624</a>
                            <a href='#' className='font-DM_sans text-base font-normal flex items-center hover:text-red-200'>< IoIosMail className='text-xl mr-5' /> bachkhoa@hcmut.edu.vn</a>
                            <a href='#' className='font-DM_sans text-base font-normal flex hover:text-red-200'>< HiOutlineMapPin className='text-2xl mr-5' />268 Đ. Lý Thường Kiệt, Phường 14, Quận 10, Hồ Chí Minh</a>
                        </ul>
                    </ul>

                    {/* ----------- About info Part ----------- */}
                    <ul className='w-[560px] flex flex-col gap-6 justify-start'>
                        <h3 className='font-PlayfairD font-medium text-[55px] leading-[60px]'>Chúng tôi cung cấp bữa ăn ngon cho gia đình.</h3>
                        <p className='font-DM_sans font-medium text-lg text-[#2C2F24]'>Câu chuyện của chúng tôi bắt đầu với một tầm nhìn tạo ra một trải nghiệm ẩm thực độc đáo, kết hợp giữa ẩm thực cao cấp, dịch vụ xuất sắc và không gian sôi động. Được hình thành từ nền văn hóa ẩm thực phong phú của thành phố, chúng tôi mong muốn tôn vinh cội nguồn địa phương trong khi hòa quyện với khẩu vị toàn cầu.</p>
                        <p className='font-DM_sans font-normal text-base text-[#414536]'>Tại đây, chúng tôi tin rằng việc thưởng thức ẩm thực không chỉ đơn thuần là món ăn, mà còn là toàn bộ trải nghiệm. Đội ngũ nhân viên của chúng tôi, nổi tiếng với sự thân thiện và tận tâm, luôn nỗ lực để biến mỗi lần ghé thăm thành một kỷ niệm khó quên.</p>
                        <Link to = "/about"><button className='w-[180px] h-[65px] rounded-full border-2 border-[#2c2f24] font-DM_sans font-bold text-base text-[#182226] mt-4 hover:text-white hover:border-white hover:bg-black transition duration-800'>Thông tin thêm</button></Link>
                    </ul>
                </div>
            </section>
            ...
            <section className='py-[120px] container'>
                <h3 className='font-PlayfairD font-medium text-[55px] leadin-[60px] text-center'>Chúng tôi cung cấp <br /> dịch vụ tổ chức sự kiện</h3>
                <ul className='mt-16 flex justify-between'>
                    ...
                    <ul className='flex flex-col justify-start gap-6 w-[306px] hover:scale-105 duration-300 will-change-transform'>
                        ...
                        <li className='font-DM_sans font-normal text-base'>Bữa tiệc đầy ắp niềm vui và hạnh phúc.</li>
                    </ul>
            ...
            <section className='bg-[#f9f9f7] py-[120px]'>
                <ul className='container flex justify-between'>
                    ...
                    <ul className='w-[460px] flex flex-col gap-5 justify-center'>
                        <li className='font-PlayfairD font-medium text-[55px] leading-[60px]'>Giao hàng tận nơi trong Thành Phố</li>
                        <li className='font-DM_sans font-normal text-base text-[#414536]'>Giao hàng nhanh và thuận tiện. </li>
                        <ul className='flex flex-col gap-4'>
                            <li className='flex items-center gap-4 text-xl font-DM_sans font-normal'><span className='p-2 text-white text-2xl bg-[#AD343E] rounded-full hover:bg-[#ca555f]'><IoMdTime/></span> Giao trong vòng 30 phút</li>
                            <li className='flex items-center gap-4 text-xl font-DM_sans font-normal'><span className='p-2 text-white text-2xl bg-[#AD343E] rounded-full hover:bg-[#ca555f]'><HiOutlineReceiptPercent/></span>Giá tốt nhất</li>
                            <li className='flex items-center gap-4 text-xl font-DM_sans font-normal'><span className='p-2 text-white text-2xl bg-[#AD343E] rounded-full hover:bg-[#ca555f]'><LuShoppingCart/></span>Đặt món Online</li>
                        </ul>
                    </ul>
                </ul>
            </section >
            ...
            <section className='container pt-[120px] py-5'>
                ...
                <ul className='flex justify-between'>
                    <h4 className='font-PlayfairD font-medium text-[55px] leading-[60px]'>Các bài viết</h4>

                    {/* -------- button for go to article page -------- */}
                    <Link to = "/blog"><button className='w-[190px] h-[65px] bg-[#AD343E] text-white rounded-full hover:bg-red-600 transition duration-200'>Đọc tất cả</button></Link> 
                </ul>
                ...
                <ul className='mt-[130px] flex justify-between'>
                    ...
                    <Link to = "/blog/burger_details" className='w-[836px] rounded-xl border-2 hover:scale-105 transition duration-200 will-change-transform'>
                        ...
                        <ul className='py-12 px-8 flex flex-col gap-[15px]'>
                            <li className='font-DM_sans font-medium text-base text-[#737865]'>10-04-2025</li>
                            <li className='font-DM_sans font-medium text-xl'>Cách làm món Ốc om chuối đậu</li>
                            <li className='font-DM_sans font-normal text-base'>Cách làm món ốc om chuối đậu ngon.</li>
                        </ul>
                    </Link>
                    ...
                    <div className='w-[640px] flex flex-wrap gap-6'>
                        ...
                        <ul className='w-[306px] rounded-xl border-2 hover:scale-105 duration-300 will-change-transform'>
                            ...
                            <ul className='p-[25px]'>
                                <li className='font-DM_sans font-medium text-sm text-[#737865]'>10-04-2025</li>
                                <li className='mt-3 font-DM_sans font-medium text-xl'>Cách làm món Ốc om chuối đậu</li>
                            </ul>
                        </ul>
