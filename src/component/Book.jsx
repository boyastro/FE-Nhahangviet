        ...
        <>
            ...
            <section >
                ...
                <header className='container text-center mt-4'>
                    <h1 className='font-PlayfairD text-[100px] font-normal leading-[96px]'>Đặt bàn</h1>
                    <p className='font-DM_sans text-lg leading-[28px] font-normal mt-6'>Hãy cho chúng tôi biết bạn cần gì <br /> chúng tôi sẽ phục vụ bạn.</p>
                </header>
                ...
                <form onSubmit={handleSubmit} className='w-[800px] container p-10 mt-[72px] shadow-2xl rounded-2xl'>
                    <ul className='flex gap-6 flex-col'>
                        <ul className='flex gap-2'>
                            ...
                            {/* for time */}
                            <li className='relative'>
                                <p className='ml-4 font-DM_sans font-bold text-base'>Thời gian</p>
                        ...
                        <ul className='flex gap-2'>
                            ...
                            <li className='relative'>
                                ...
                                <input onChange={handleName} type="text" placeholder='Ghi tên của bạn' className='w-[350px] h-[60px] rounded-full border-2 px-4 mt-2 outline-none' />
                                <p className='font-DM_sans font-medium text-sm text-red-400 absolute top-0 right-5'>{nameError}</p>
                            </li>

                            {/* for phone */}
                            <li className='relative'>
                                <p className='ml-4 font-DM_sans font-bold text-base'>Số điện thoại</p>
                                <input onChange={handlePhone} type="number" placeholder='Ghi số điện thoại' className='w-[350px] h-[60px] rounded-full border-2 px-4 mt-2 outline-none' />
                        ...
                        <ul className='relative'>
                            <p className='ml-4 font-DM_sans font-bold text-base'>Số lượng người</p>
